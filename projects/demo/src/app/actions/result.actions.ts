...
export const appendResult = createAction('[Result] Append Result', props<{ result: Result }>());
export const replaceResult = createAction('[Result] Replace Result', props<{ result: Result }>());
